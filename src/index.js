...
/*
 ...
 Пример:
   ...
   // добавит такой обработчик кликов для указанного элемента, который вызовется только один раз 
   и затем удалится
 */
function once(target, fn) {
    let handlerClick = function() {
        fn();
        target.removeEventListener('click', handlerClick);
    }

    target.addEventListener('click', handlerClick);
}
