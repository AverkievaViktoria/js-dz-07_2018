...
/*
 ...
 Пример:
   ...
   findAllPSiblings(document.body) 
     // функция должна вернуть массив с элементами div и span т.к. следующим соседом этих 
     элементов является элемент с тегом P
 */
    ...
    let collect = function(root) {
        for (const node of root.childNodes) {
            ...
            if (node.nodeType === Node.TEXT_NODE) {
                ...
                if (n) {
                    (r.tags.hasOwnProperty(n)) ? r.tags[n]++ : r.tags[n] = 1;
                ...
                for (let c of classList) {
                    (r.classes.hasOwnProperty(c)) ? r.classes[c]++ : r.classes[c] = 1;
                }
